...
translate spanish strings:
    ...
    new "Se ha detectado un problema y Windows ha sido apagado para evitar daños al equipo."

    # game/mod_extras/bsod.rpy:74
    old "The problem seems to be caused by the following file: "
    new "El problema parece estar causado por el siguiente archivo: "
    ...
    new "Si esta es la primera vez que ve esta pantalla de error de detención, reinicie el equipo. Si esta pantalla aparece de nuevo, siga estos pasos:"
    ...
    new "Compruebe que cualquier hardware o software nuevo esté instalado correctamente. Si se trata de una instalación nueva, pregunte al fabricante del hardware o software por las actualizaciones de Windows que pueda necesitar."
    ...
    new "Si los problemas continúan, deshabilite o elimine cualquier hardware o software recién instalado. Deshabilite las opciones de memoria de la BIOS como el almacenamiento en caché o la sombra. Si necesita usar el Modo seguro para quitar o deshabilitar componentes, reinicie el equipo, presione F8 para seleccionar Opciones de inicio avanzadas y, a continuación, seleccione Modo seguro."

    # game/mod_extras/bsod.rpy:79
    old "Technical information:"
    new "Información técnica:"
    ...
    new "   -   Dirección FBF92317 base en FBF102721, Datestamp 3d6dd67c"
    ...
    new "Tu dispositivo ha sufrido un problema y necesita reiniciarse."

    # game/mod_extras/bsod.rpy:138
    old "We're just collecting some error info, and then you can"
    new "Estamos recopilando información sobre el error y después podrás"
    ...
    new "Para obtener más información sobre este problema y sus posibles soluciones, visita https://www.windows.com/stopcode"

    # game/mod_extras/bsod.rpy:154
    old "If you call a support person, give them this info:"
    new "Si llamas a una persona de soporte técnico, dales esta información:"

    # game/mod_extras/bsod.rpy:155
    old "Stop code: "
    new "Código de detención: "

    # game/mod_extras/bsod.rpy:165
    old "For more information about this issue and possible fixes, visit"
    new "Para obtener más información sobre este problema y sus posibles soluciones, visita"

    # game/mDoki Doki Literature Club/game/mod_extras/bsod.rpy:166
    ...
    new "Necesitas reiniciar el equipo. Mantén presionado el botón de\n"

    # game/mod_extras/bsod.rpy:182
    old "button until it turns off, then press the Power button again."
    new "encendido hasta que se apague y, después, vuelve a presionarlo."
    ...
    new "Devi riaviaia il computer. Tieni premuto il pulsante di\n"
    ...
    new "hda0: METAVERSE ENTERPRISE VIRTUAL HARDDISK, ATA DISK drive"
    ...
    new "hdc: METAVERSE ENTERPRISE VIRTUAL CD-ROM, ATAPI CD/DVD-ROM drive"
    ...
    new "hda: 2147483648 sectors (1 TB) w/256KiB Cache, CHS=178/255/63, (U)DMA"
    ...
    new "DDLC.so[[3A52]: Importing _renpysteam: ImportError('No module named _renpysteam',)"

    # game/mod_extras/bsod.rpy:221
    old "DDLC.so[[3352]: nvdrs: Loaded, about to disable thread optimizations."
    new "DDLC.so[[3A52]: nvdrs: Loaded, about to disable thread optimizations."

    # game/mod_extras/bsod.rpy:222
    old "DDLC.so[[3352]: nvdrs: Disabled thread optimizations."
    new "DDLC.so[[3A52]: nvdrs: Disabled thread optimizations."

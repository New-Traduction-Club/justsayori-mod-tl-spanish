...
translate spanish mg_bnc_5fa563ba:

    # s gbaaipa "..."
    s gbaaipa "..."

# game/additional/mg_bnc.rpy:140
translate spanish mg_bnc_s_comment_fd0b0449:

    # s abaaaoa "I propose you a number of [bnc.guessed_len] digits..."
    s abaaaoa "Te propongo un número de [bnc.guessed_len] dígitos..."

# game/additional/mg_bnc.rpy:141
translate spanish mg_bnc_s_comment_f1211275:

    # s "Try to guess it."
    s "Intenta adivinarlo."

# game/additional/mg_bnc.rpy:144
translate spanish mg_bnc_s_comment_8fb5e037:

    # s bbaaada "Are you giving up?"
    s bbaaada "¿Te rindes?"

# game/additional/mg_bnc.rpy:146
translate spanish mg_bnc_s_comment_a40713db:

    # s abaacia "Your tries are over."
    s abaacia "Se te acabaron los intentos."
...
translate spanish mg_bnc_s_comment_1f187c67:
    ...
    s abaadaa "Vale, te diré la respuesta correcta."

# game/additional/mg_bnc.rpy:151
translate spanish mg_bnc_s_comment_1f44fb3e:

    # s abaaloa "The right number was {i}[bnc.guessed]{/i}."
    s abaaloa "El número correcto era el '[bnc.guessed]'."

# game/additional/mg_bnc.rpy:152
translate spanish mg_bnc_s_comment_1f5e092d:

    # s ebaacqa "Let me think of another number."
    s ebaacqa "Déjame pensar en otro número."

# game/additional/mg_bnc.rpy:155
translate spanish mg_bnc_s_comment_c36bfebb:

    # s abaacoa "You're right. It was {i}[bnc.guessed]{/i}!"
    s abaacoa "¡Has acertado! ¡Era el '[bnc.guessed]'!"

# game/additional/mg_bnc.rpy:156
translate spanish mg_bnc_s_comment_4f687ab2:

    # s abaaaea "Let's play one more time."
    s abaaaea "Juguemos una vez más."
...
translate spanish mg_bnc_s_comment_20dca1e6:
    ...
    s "Estoy muy molesta ahora mismo..."

# game/additional/mg_bnc.rpy:162
translate spanish mg_bnc_s_comment_2c908695:

    # s gbaabpa "So I don't want to play this game with you anymore."
    s gbaabpa "Así que ya no quiero jugar más a este juego contigo."

# game/additional/mg_bnc.rpy:163
translate spanish mg_bnc_s_comment_d81f2c6d:

    # s "I won't lose next time."
    s "No perderé la próxima vez."
...
translate spanish strings:
    ...
    new "'Respuesta correcta: [bnc.guessed]'"
    ...
    new "¡Longitud incorrecta! Tu respuesta debe consistir en [bnc.guessed_len] dígitos diferentes."
    ...
    new "Última oportunidad, [mr] No Sé Contar Hasta [bnc.guessed_len]."

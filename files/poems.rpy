...
init 5 python:
    reg_poem_trans("long_wait", spanish_long_wait)
    reg_poem_trans("poem_sunshine", spanish_poem_sunshine)
    reg_poem_trans("poem_bottles", spanish_poem_bottles)
    reg_poem_trans("poem_flower", spanish_poem_flower)
    reg_poem_trans("poem_last", spanish_poem_last)
    reg_poem_trans("poem_fruits", spanish_poem_fruits)
    reg_poem_trans("poem_angel", spanish_poem_angel)
    reg_poem_trans("poem_leaf", spanish_poem_leaf)
